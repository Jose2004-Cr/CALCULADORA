          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <button
                ...
                className="w-full p-2 mt-2 text-white transition-all ease-in-out bg-blue-800 rounded hover:bg-blue-800"
              >
            ...
            <button
              type="submit"
              className="w-full bg-[#1c2293] text-white p-2 rounded hover:bg-opacity-80 transition-all ease-in-out hover:scale-[103%]"
            >
              Calcular Integral
            </button>
          </form>
